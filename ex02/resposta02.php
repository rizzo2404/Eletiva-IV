...
<head>
    <meta charset="utf-8">
    <title>Exercício 2 - Subtração (Resultado)</title>
</head>
<body>
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    echo "<p>Envie os dados através do formulário. <a href='index02.php'>Voltar</a></p>";
    exit;
}
...
if ($n1_raw === null || $n2_raw === null) {
    echo "<p style='color:red;'>Dados incompletos. <a href='index02.php'>Voltar</a></p>";
    exit;
}
...
if ($n1 === false || $n2 === false) {
    echo "<p style='color:red;'>Valores inválidos. <a href='index02.php'>Voltar</a></p>";
    exit;
}
...
?>
    ...
    <p><a href="index02.php">Voltar ao formulário</a></p>
</body>
</html>
